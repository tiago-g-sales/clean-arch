...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListAllOrdersResponse, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListAllOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*ListAllOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*ListAllOrdersResponse, error) {
